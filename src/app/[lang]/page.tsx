        ...
        <div className="relative flex flex-col items-center gap-6">
          ...
          <div className="mt-2 flex flex-wrap items-center justify-center gap-6">
            <div className="flex flex-col items-center gap-1.5">
              <a
                href="https://github.com/vivrecard-ops/motherflame-releases/releases/download/v1.9.22/MotherFlame_Setup_v1.9.22.exe"
                download
      ...
      <section id="download" className="px-6 py-24">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <div className="mt-8 flex flex-col items-center gap-3">
            ...
            <span className="text-xs text-zinc-600">v1.9.22 · 68 MB · .exe</span>
            <a
              href="https://github.com/vivrecard-ops/motherflame-releases/releases/download/v1.9.22/MotherFlame_v1.9.22.zip"
              className="text-xs text-zinc-500 underline-offset-2 hover:text-zinc-300 hover:underline"
            >
